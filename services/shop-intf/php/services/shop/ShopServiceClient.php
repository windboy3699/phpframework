...
class ShopServiceClient implements \services\shop\ShopServiceIf
{
    ...
    {
        $args = new \services\shop\ShopService_sayHello_args();
        $args->name = $name;
    ...
    public function recv_sayHello()
    {
        ...
        if ($bin_accel) {
            $result = thrift_protocol_read_binary(
                $this->input_,
                '\services\shop\ShopService_sayHello_result',
            ...
            $result = new \services\shop\ShopService_sayHello_result();
